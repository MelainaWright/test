...
#two file apps, one directory with two files: server.R (for function) and ui.R (for fluidPage) or one file "app.R" in that folder. the only other stuff in that folder should be stuff the app needs
...
#or can hit run app/reload app in R and then hit publish from window that pops up and it will publish it online on your account
